...
<body>
  <div class="container my-5" id="background">
      ...
      <div class="col-md-6">
        <div class="section-card">
          ...
          <div class="d-grid gap-3">
            ...
            <a class="btn btn-blue btn-sm btn-custom rounded-pill" href="{{ route('ReleaseResults') }}">
              <i class="bi bi-send-check-fill me-1"></i>Release Results
            </a>
    ...
    <div class="d-flex justify-content-center gap-3 mt-5">
      <a class="btn btn-orange btn-sm btn-custom rounded-pill" href="#">
        <i class="bi bi-arrow-left-circle me-1"></i>Back
      </a>
      <a class="btn btn-blue btn-sm btn-custom rounded-pill" href="#">
        <i class="bi bi-check-circle-fill me-1"></i>Submit
      </a>
      <a class="btn btn-orange btn-sm btn-custom rounded-pill" href="{{ route('logout') }}">
