            ...
            <div class="card shadow-sm border-0">
                <div class="card-header bg-white border-0 py-3">
                    <div class="d-flex justify-content-between align-items-center">
                        <h2 class="h5 mb-0">
                            <i class="fas fa-user-plus text-primary me-2"></i>Add New Admin
                        </h2>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('manage-admins.store') }}" method="POST" class="needs-validation" novalidate>
                        @csrf
                        ...
                        <div class="mb-4">
                            <div class="form-check form-switch">
                                ...
                                <label class="form-check-label fw-semibold" for="is_super">
                                    <i class="fas fa-shield-alt me-1 text-muted"></i> Grant Super Admin Privileges
                                </label>
